...
def run_xgboost_full() -> tuple[pd.DataFrame, list[dict]]:
    ...
    save_prediction_outputs(
        out,
        {"model": "xgboost", "conformal": "full_approx", "params": XGB_PARAMS, "results": summary},
        MODEL_DIR / "xgboost_full_predictions.csv",
        MODEL_DIR / "xgboost_full_summary.json",
    )
    return out, summary
